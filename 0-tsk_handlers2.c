...
/**
 * _print_r - Custom conversion specifier for printing strings.
 *            Non-printable characters (0 < ASCII value < 32 or >= 127)
 *            are printed as \x followed by the ASCII code in hexadecimal.
 * @arlist: A va_list containing the string to print.
 *
 * Return: The number of characters printed.
 */
